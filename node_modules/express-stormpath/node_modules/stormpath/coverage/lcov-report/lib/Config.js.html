...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var deepExtend = require('deep-extend');
...
<span class="branch-0 cbranch-no" title="branch not covered" >  'USERPROFILE' </span>: 'HOME'];
&nbsp;
...
<span class="branch-0 cbranch-no" title="branch not covered" >  fs.readSync(currentConfigPath) </span>: {};
&nbsp;
var userConfig = fs.existsSync(userConfigPath) ?
<span class="branch-0 cbranch-no" title="branch not covered" >  fs.readSync(userConfigPath) </span>: {};
&nbsp;
/**
 * @class Config
...
function Config(options){
  ...
  deepExtend(this,userConfig||<span class="branch-1 cbranch-no" title="branch not covered" >{})</span>;
  deepExtend(this,currentConfig||<span class="branch-1 cbranch-no" title="branch not covered" >{})</span>;
