...
&nbsp;
CustomData.prototype.get = <span class="fstat-no" title="function not covered" >function getCustomData(callback){</span>
<span class="cstat-no" title="statement not covered" >  return this.dataStore.getResource(this.href, null, CustomData, callback);</span>
};
&nbsp;
